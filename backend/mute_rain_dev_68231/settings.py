"""
Django settings for mute_rain_dev_68231 project.
...
ROOT_URLCONF = 'mute_rain_dev_68231.urls'
...
WSGI_APPLICATION = 'mute_rain_dev_68231.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_rain_dev_68231 API",
    "DESCRIPTION": "API documentation for mute_rain_dev_68231 App",
    "VERSION": "v1",
}
